...
export const companies = pgTable("companies", {
  ...
  logoThumbnailUrl: text("logo_thumbnail_url"),
  ...
  galleryThumbnails: text("gallery_thumbnails").array(),
...
export const insertCompanySchema = createInsertSchema(companies, {
  ...
  logoThumbnailUrl: z.string().nullable().optional(),
  ...
  galleryThumbnails: z.array(z.string()).nullable().optional(),
